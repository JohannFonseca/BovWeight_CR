...
<body>
    <div class="container">
        <div class="header">
            <h1>BovWeight CR</h1>
            <p>Monitoreo Inteligente de Hato</p>
        </div>
        <div class="content">
            <div class="greeting">¡Hola, {{ $nombre }}!</div>
            <div class="message">
                Su cuenta en BovWeight CR ha sido creada exitosamente. A continuación encontrará sus credenciales de acceso temporal.
            </div>
            ...
            <div class="alert-box">
                <p><strong>⚠️ Importante:</strong> Esta contraseña expirará en 24 horas y al iniciar sesión por primera vez se le solicitará cambiarla obligatoriamente por motivos de seguridad.</p>
            </div>
        </div>
        <div class="footer">
